                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .confirmarEmailTextController,
                                              focusNode: _model
                                                  .confirmarEmailFocusNode,
                                              autofocus: true,
                                              autofillHints: [
                                          ...
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                if (_model.outputAcao!) {
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(
                                                    SnackBar(
                                                      content: Text(
                                                        'Seu CPF é valido e conta criada!',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .primaryText,
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'Seu CPF é invalido e conta não criada tente novamente!',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .primaryText,
